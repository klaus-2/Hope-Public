...
module.exports = class Tattoo extends Command {
  constructor(bot) {
    super(bot, {
      ...
      description: 'Sends a random nsfw tattoo\'d female', //Sends a random nsfw tattoo\'d female
      usage: 'tattoo',
      cooldown: 5000,
      slash: true,
    });
  ...
  async run(bot, message, settings) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      /*var hook = await message.channel.createWebhook(WebhookNames[random], { avatar: `https://i.imgur.com/${WebhookAvatars[random]}.gif`, reason: `command ${settings.prefix}tattoo by ${message.author.username}` })
