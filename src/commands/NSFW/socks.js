...
module.exports = class Meias extends Command {
  constructor(bot) {
    super(bot, {
      name: 'socks',
      nsfw: true,
  ...
  async run(bot, message, settings) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      /*var hook = await message.channel.createWebhook(WebhookNames[random], { avatar: `https://i.imgur.com/${WebhookAvatars[random]}.gif`, reason: `command ${settings.prefix}socks by ${message.author.username}` })
