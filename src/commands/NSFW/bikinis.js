...
module.exports = class Biquini extends Command {
  constructor(bot) {
    super(bot, {
      name: 'bikinis',
      nsfw: true,
      ...
      aliases: ['biquini'],
      description: 'Look at Pictures of girls in bikinis! 👙',
      usage: 'biquini',
      cooldown: 5000,
      slash: true,
    });
  ...
  async run(bot, message, settings) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      /*var hook = await message.channel.createWebhook(WebhookNames[random], { avatar: `https://i.imgur.com/${WebhookAvatars[random]}.gif`, reason: `command ${settings.prefix}bikinis by ${message.author.username}` })
