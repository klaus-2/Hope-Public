			...
			get('https://nekobot.xyz/api/image?type=hneko')
				.then(res => {
					...
					return new Promise(async (resolve, reject) => {
						...
						/*var hook = await message.channel.createWebhook(WebhookNames[random], { avatar: `https://i.imgur.com/${WebhookAvatars[random]}.gif`, reason: `command ${settings.prefix}hneko by ${message.author.username}` })
